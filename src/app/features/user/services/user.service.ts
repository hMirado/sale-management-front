...
import { ITableFilterFieldValue, ITableFilter } from 'src/app/shared/models/i-table-filter/i-table-filter';
...
export class UserService {
  ...
  getUsers(_params: any = {}): Observable<ApiResponse> {
    ...
    if (_params['role'] &&(_params['role'] != '' && _params['role'] != 'all')) params['role'] = _params['role'];
    const url = `${environment['store-service']}/user`;
